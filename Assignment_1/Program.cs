...
namespace Assignment_1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("{0,-15}{1,15}", "iPhone-Black", "$1599.00");
            Console.WriteLine("{0,-15}{1,15}", "iPhone-Blue",  "$1689.00");
            Console.WriteLine("{0,-15}{1,15}", "iPhone-White", "$1549.00");
            Console.WriteLine("{0,-15}{1,15}", "iPad-Blue",    "$1049.99");
            Console.WriteLine("{0,-15}{1,15}", "iPad-Grey",    "$1099.99");
            ...
            do
            {
                ...
                do
                {
                    ...
                    if (Type == "iPhone" || Type == "iPad" || Type == "iphone" || Type == "ipad" )
                    {
                        Console.WriteLine("\n- You selected " + Type);
                        incorrect = false;
                    }
                ...
                if (color == "blue" && (Type == "iPhone" || Type == "iphone"))
                {
                    bluePhone      = true;
                ...
                if (color == "black" && (Type == "iPhone" || Type == "iphone"))
                {
                    blackPhone      = true;
                ...
                if (color == "white" && (Type == "iPhone" || Type == "iphone"))
                {
                    whitePhone      = true;
                ...
                if (color == "blue" && (Type == "iPad" || Type == "ipad"))
                {
                    blueTablet      = true;
                ...
                if (color == "grey" && (Type == "iPad" || Type == "ipad"))
                {
                    greyTablet      = true;
            ...
            } while (checkout == false);    //if user dont want ot checkout then ask the question for next item
            ...
            if (blackPhone == true)
            {
                Console.WriteLine("{0,-15}{1,-15}{2,15}{3,15}{4,15}{5,15:$0.00}", "iPhone", "Phone, Black", "$" + BlackPhonePrice, BlackPhoneQty, BlackPhoneDis + "%", BlackPhoneTotal);
                Totalsavings = (BlackPhoneQty * BlackPhonePrice) - BlackPhoneTotal;     //saving = total price - total discounted price
            ...
            if (bluePhone == true)
            {
                Console.WriteLine("{0,-15}{1,-15}{2,15}{3,15}{4,15}{5,15:$0.00}", "iPhone", "Phone, Blue", "$" + BluePhonePrice, BluePhoneQty, BluePhoneDis + "%", BluePhoneTotal);
                Totalsavings = Totalsavings + ((BluePhoneQty * BluePhonePrice) - BluePhoneTotal);    //totalsavings added to the right side beacuase if the user already 1 item then added that saving in this equation
            ...
            if (whitePhone == true)
            {
                Console.WriteLine("{0,-15}{1,-15}{2,15}{3,15}{4,15}{5,15:$0.00}", "iPhone", "Phone, White", "$" + WhitePhonePrice, WhitePhoneQty, WhitePhoneDis + "%", WhitePhoneTotal);
                Totalsavings = Totalsavings + ((WhitePhoneQty * WhitePhonePrice) - WhitePhoneTotal);   //totalsavings added to the right side beacuase if the user already 1 item then added that saving in this equation
            ...
            if (blueTablet == true)
            {
                Console.WriteLine("{0,-15}{1,-15}{2,15}{3,15}{4,15}{5,15:$0.00}", "iPad", "Tablet, Blue", "$" + BlueTabletPrice, BlueTabletQty, BlueTabletDis + "%", BlueTabletTotal);
                Totalsavings = Totalsavings + ((BlueTabletQty * BlueTabletPrice) - BlueTabletTotal);   //totalsavings added to the right side beacuase if the user already 1 item then added that saving in this equation
            ...
            if (greyTablet == true)
            {
                Console.WriteLine("{0,-15}{1,-15}{2,15}{3,15}{4,15}{5,15:$0.00}", "iPad", "Tablet, Grey", "$" + GreyTabletPrice, GreyTabletQty, GreyTabletDis + "%", GreyTabletTotal);
                Totalsavings = Totalsavings + ((GreyTabletQty * GreyTabletPrice) - GreyTabletTotal);   //totalsavings added to the right side beacuase if the user already 1 item then added that saving in this equation
